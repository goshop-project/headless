module goshop.dev/headless/pkg/server
...
require (
	darvaza.org/acmefy/pkg/client v0.0.0-00010101000000-000000000000
	darvaza.org/core v0.9.2
	darvaza.org/darvaza/agent v0.2.2
	darvaza.org/darvaza/shared v0.5.1
	darvaza.org/gossipcache v0.3.1
...
require (
	...
	darvaza.org/cache v0.2.0 // indirect
	darvaza.org/cache/x/groupcache v0.1.2 // indirect
